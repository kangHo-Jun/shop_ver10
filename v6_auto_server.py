...
<html>
<head>
    <title>V6 Automation Control</title>
    <style>
        body { font-family: 'Segoe UI', sans-serif; padding: 20px; background-color: #1a1a2e; color: #eee; }
...
<body>
    <div class="container">
        <h1>🚀 V6 Automation Control</h1>
        <p class="subtitle">원장조회 + 견적조회 듀얼 다운로드 시스템</p>
...
if __name__ == "__main__":
    print("="*50)
    print("V6 Hybrid Automation Server")
    print("원장조회 + 견적조회 듀얼 다운로드 시스템")
    print("Access the UI at: http://localhost:5050")
    print("="*50)
